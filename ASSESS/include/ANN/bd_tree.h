...
public:
	...
	virtual void ann_searchContinuous_BottomUp(ANNdist box_dist, checkActiveClass2 *checkActive,ANNkd_ptr caller, int);
	virtual void ann_searchContinuous_BottomUp(ANNdist box_dist, checkActiveClass3 *checkActive,ANNkd_ptr caller, int);
	virtual void ann_searchContinuous_BottomUp(ANNdist box_dist, checkActiveClass3 *checkActive,ANNkd_ptr caller, int, compressed_matrix<double>*);
	virtual bool annDeleteNode(int, ANNdist);
	virtual bool annDeleteNode_BottomUp(int);
